...
const PaginateTable = () => {
    const { tableData, apiOriginal, startPagination, endPagination, page, setPage, nextPagination,previusPagination } = useInventario();
    ...
    <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        <div>
            <p className="text-sm text-gray-700">
                ...
                <span className="font-medium">{apiOriginal.length}</span> Productos en Total
            </p>
        </div>
        <div>
